...
Подписанные APK и Google Play App Bundle публикуются в [Releases](https://github.com/Lugovskoy-Maxim/tomilo-lib-android/releases).

В релиз попадают RuStore APK, Play AAB и их SHA-256. Для Google Play Console загружайте файл `tomilo-lib-{version}.aab`. R8 mapping, keystore и пароли в репозиторий и в Releases не публикуются.
